  ...
  text: (
    <div>
      ...
      <p>
        ...
        , and playing legos with my kids on our dining room table.
      </p>
    </div>
  ),
  links: [
...
export const TESTIMONIALS = [
  {
    text: (
      <div>
        <p>
          Ben worked in my team at WealthEngine. He is a very seasoned UX
          designer - an all-rounder who knows not only how to design great user
          experiences with style and usability but also develop full frontend
          components in React using data. I know very few designers who are full
          stack like him, skilled in tools like Sketch and Photoshop to HTML,
          SCSS, JS and React that are needed for creating rich, interactive
          prototypes.
        </p>
        <p>
          Ben saved us a ton of lead time by creating reusable style standards
          and components that developers could directly use in production.
        </p>
        <p>
  ...
  },
  {
    text: (
      <div>
        <p>
          Ben has this amazingly calm demeanor and earnestly strives to deliver
          web-based user interfaces as specificated by the product team in
          conjunction with what is needed by the end-users. He methodically puts
          in the time to understand what is required, he focuses his effort on
          what is the most logical and workable in the end, and he continues to
          hone his skills to be on the forefront of front end web design. I was
          fortunate to be able to work with him to clarify workflow, reports,
          and results on several projects over the years, and he was always
          respectful of everyone that he interacted with at WealthEngine.
        </p>
      </div>
    ),
    ...
    text: (
      <div>
        <p>
          ...
          for any UX/UI role and wish him all the best for future endeavours.
        </p>
      </div>
    ),
  ...
  },
  {
    text: (
      <div>
        <p>
          By combining an artist’s eye with JavaScript chops, Ben brings vivid
          front-end experiences to life! I’m a full-stack dev, but lean towards
          the back-end side of things. Ben helped me create a beautiful
          front-end web experience for Tempora, a meditation app I work on in my
          free time.
        </p>
      </div>
    ),
